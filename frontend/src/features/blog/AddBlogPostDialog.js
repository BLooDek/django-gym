...
import { setAddDialog } from "./blogState";

export default function AddBlogPostDialog({ handleAdd }) {
  const dispatch = useDispatch();
  const isOpen = useSelector((state) => state.blogState.addDialog);
      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              {/* TODO: zmienić max-w-md na cos lepszego do pisania */}
              <div className="xl:w-1/2 lg:w-3/4 inline-block w-full  p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white border-2 border-black shadow-xl rounded-2xl">
                ...
                <AddBlogPostForm handleAdd={handleAdd} />
