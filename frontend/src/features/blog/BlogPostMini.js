...
export default function BlogPostMini({ post }) {
  return (
    <>
      <div className="p-4 md:w-1/3 ">
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-purple-main">
          <img
          ...
          <div className="p-6">
            ...
            <div className="flex items-center flex-wrap ">
              <Link 
              to={`/django-gym/blog/${post.id}`} key={post.id}>
                <span 
                id={`BlogPostDetailsId-${post.id}`}
                className="text-white inline-flex items-center md:mb-2 lg:mb-0 hover:underline">
                  Learn More
                  <svg
